...
abstract class AbstractAppHandle implements SparkAppHandle {
     ...
     * <p>
     * This method should be called only when there's a reasonable expectation that the communication with the child
     * application is not needed anymore, either because the code managing the handle has said so, or because the child
