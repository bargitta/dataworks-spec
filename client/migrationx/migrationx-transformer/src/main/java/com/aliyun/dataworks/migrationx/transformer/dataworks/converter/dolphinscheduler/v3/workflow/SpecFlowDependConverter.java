...
public class SpecFlowDependConverter {
    ...
    private List<SpecFlowDepend> convertTaskRelationList(List<ProcessTaskRelation> taskRelationList) {
        ...
        Map<Long, String> taskCodeNodeDataMap = DolphinSchedulerV3Context.getContext().getTaskCodeNodeDataMap();
        Map<Long, String> taskCodeNodeIdMap = DolphinSchedulerV3Context.getContext().getTaskCodeNodeIdMap();
