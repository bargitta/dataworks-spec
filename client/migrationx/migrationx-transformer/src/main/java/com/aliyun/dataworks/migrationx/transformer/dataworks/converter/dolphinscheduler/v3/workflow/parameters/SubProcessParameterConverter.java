...
public class SubProcessParameterConverter extends AbstractParameterConverter<SubProcessParameters> {
    ...
    public SubProcessParameterConverter(Properties properties, SpecWorkflow specWorkflow, DagData processMeta, TaskDefinition taskDefinition) {
    ...
    protected void convertParameter(SpecNode specNode) {
        ...
        DolphinSchedulerV3Context.getContext().getSubProcessCodeNodeMap().put(depProcessCode, specNode);
    }
}
