...
public class DolphinSchedulerV2WorkflowConverter {
    ...
    public DolphinSchedulerV2WorkflowConverter(DolphinSchedulerPackage<Project, DagData, DataSource, ResourceComponent, UdfFunc> dolphinSchedulerPackage,
    ...
    private void handleSubprocess() {
        Map<Long, Object> codeWorkflowMap = DolphinSchedulerV2Context.getContext().getSubProcessCodeWorkflowMap();
        Map<Long, Object> codeNodeMap = DolphinSchedulerV2Context.getContext().getSubProcessCodeNodeMap();
        //find subprocess
    ...
    private void handleDependents(List<Specification<DataWorksWorkflowSpec>> specifications) {
        ...
        Map<Long, Object> taskCodeSpecNodeMap = DolphinSchedulerV2Context.getContext().getTaskCodeSpecNodeMap();
        Map<Object, List<Long>> depMap = DolphinSchedulerV2Context.getContext().getSpecNodeProcessCodeMap();
