...
public class TriggerConverter {
    ...
    public TriggerConverter(SpecTrigger trigger, TaskNode taskDefinition) {
        super();
        this.schedule = null;
    ...
    private void convertByTaskDefinition() {
        ...
        convertRes.setRecurrence("NORMAL".equals(taskDefinition.getRunFlag()) ? NodeRecurrenceType.NORMAL : NodeRecurrenceType.PAUSE);
