 ...
 */
@Data
public class SpecFileResourceEntityAdapter implements DwNodeEntity {

    private SpecFileResource specFileResource;

    @Override
    public String getUuid() {
        return Optional.ofNullable(specFileResource).map(SpecRefEntity::getId).orElse(null);
    }
    ...
    public String getName() {
        return Optional.ofNullable(specFileResource).map(SpecFileResource::getName).orElse(null);
    }

    @Override
    public String getType() {
        Optional<SpecScriptRuntime> scriptRuntime = Optional.ofNullable(specFileResource)
            .map(SpecFileResource::getScript)
    ...
    public String getResourceGroup() {
        return Optional.ofNullable(specFileResource)
